 ...
 <img  src="{{env('APP_URL')}}/public/assets/img/blinkswag_loader.gif" alt="" class="spinner1">
    ...
    <div class="row">
        <div class="col-md-12 text-right">
            <a class="nav-link btn btn-default saveproduct w-25 mb-2" style="color: white !important; margin:auto; display:none">Save</a>
        </div>
    </div>


{{-- cdn --}}
<link rel="stylesheet" href="{{ asset('vendor/blinkswag/store/src/public/assets/js/cdn/jquery.Jcrop.css') }}">
...
<script src="{{ asset('vendor/blinkswag/store/src/public/assets/js/cdn/jquery.Jcrop.js') }}"></script>
