...
{{-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.9/dist/css/bootstrap-select.min.css" referrerpolicy="no-referrer" /> --}}
<style>
   ul.nav.nav-tabs li {
    width: 100%;
}
...
$(document).ready(function(){
    ...
    $(document).on("click",".product_cat_id", function(){
        ...
        window.location = "{{$domain_name}}/printful/edit_printful_product/"+product_id;
        // $(".loader").show();
        // $.ajax({
        //     type: "POST",
        //     dataType:'html',
        ...
        //         _token: _token
        //     },
        //     url: "{{$domain_name}}/printful/getProductDetails",
        //     async: true,
        //     success: function(data) {
...
function addtoproductlist( elem )
    {
        ...
        $(".checkbox_size:checked").each(function(index, value){
            var check_val = $(this).val();
            selected_sizes.push(check_val);
            $(".allColors_"+check_val+" .checkbox-round:checked").each(function(index1, value1){
                var selected_variant = {};
                selected_variant["variant_id"] = $(this).attr("variant_id");
                selected_variant["size"] = check_val;
                selected_variant["color"] = $(this).attr("color_code");
                selected_variant_ids[index1] = selected_variant;

            });
        });
        //console.log("product_id", product_id);
        //console.log("selected_sizes", selected_sizes);
        //console.log("selected_variant_ids", selected_variant_ids );
        //return false;
